...
import (
	acl "github.com/EasyTier/EasyTier/go/internal/proto/acl"
	...
	peer_rpc "github.com/EasyTier/EasyTier/go/internal/proto/peer_rpc"
...
const (
	...
	ConfigSource_ConfigSourceWebhook     ConfigSource = 2
)
...
type NetworkInstanceRunningInfo struct {
	...
	Routes                []*api_instance.Route                `protobuf:"bytes,4,rep,name=routes,proto3" json:"routes,omitempty"`
	Peers                 []*api_instance.PeerInfo             `protobuf:"bytes,5,rep,name=peers,proto3" json:"peers,omitempty"`
	PeerRoutePairs        []*api_instance.PeerRoutePair        `protobuf:"bytes,6,rep,name=peer_route_pairs,json=peerRoutePairs,proto3" json:"peer_route_pairs,omitempty"`
...
func (x *NetworkInstanceRunningInfo) GetRoutes() []*api_instance.Route {
	if x != nil {
		return x.Routes
	}
	return nil
...
func (x *NetworkInstanceRunningInfo) GetPeers() []*api_instance.PeerInfo {
	if x != nil {
		return x.Peers
	}
	return nil
...
func (x *NetworkInstanceRunningInfo) GetPeerRoutePairs() []*api_instance.PeerRoutePair {
	if x != nil {
...
const file_api_manage_proto_rawDesc = "" +
	...
	"api.manage\x1a\fcommon.proto\x1a\x0epeer_rpc.proto\x1a\x12api_instance.proto\x1a\tacl.proto\"\x84!\n" +
	"\rNetworkConfig\x12$\n" +
	...
	"\x1aenable_udp_broadcast_relay\x18B \x01(\bH6R\x17enableUdpBroadcastRelay\x88\x01\x01B\x0e\n" +
	"\f_instance_idB\a\n" +
	"\x05_dhcpB\x0f\n" +
	"\r_virtual_ipv4B\x11\n" +
	...
	"\x1b_enable_udp_broadcast_relay\"\x91\x01\n" +
	...
	"\n" +
	"Standalone\x10\x02*Z\n" +
	"\fConfigSource\x12\x1b\n" +
	"\x17ConfigSourceUnspecified\x10\x00\x12\x14\n" +
	"\x10ConfigSourceUser\x10\x01\x12\x17\n" +
	"\x13ConfigSourceWebhook\x10\x022\xf4\x06\n" +
...
var file_api_manage_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_api_manage_proto_goTypes = []any{
	...
	(*PortForwardConfig)(nil),                   // 3: api.manage.PortForwardConfig
	(*MyNodeInfo)(nil),                          // 4: api.manage.MyNodeInfo
	(*NetworkInstanceRunningInfo)(nil),          // 5: api.manage.NetworkInstanceRunningInfo
	(*NetworkInstanceRunningInfoMap)(nil),       // 6: api.manage.NetworkInstanceRunningInfoMap
	(*NetworkMeta)(nil),                         // 7: api.manage.NetworkMeta
	(*ValidateConfigRequest)(nil),               // 8: api.manage.ValidateConfigRequest
	(*ValidateConfigResponse)(nil),              // 9: api.manage.ValidateConfigResponse
	(*RunNetworkInstanceRequest)(nil),           // 10: api.manage.RunNetworkInstanceRequest
	(*RunNetworkInstanceResponse)(nil),          // 11: api.manage.RunNetworkInstanceResponse
	(*RetainNetworkInstanceRequest)(nil),        // 12: api.manage.RetainNetworkInstanceRequest
	(*RetainNetworkInstanceResponse)(nil),       // 13: api.manage.RetainNetworkInstanceResponse
	(*CollectNetworkInfoRequest)(nil),           // 14: api.manage.CollectNetworkInfoRequest
	(*CollectNetworkInfoResponse)(nil),          // 15: api.manage.CollectNetworkInfoResponse
	(*ListNetworkInstanceRequest)(nil),          // 16: api.manage.ListNetworkInstanceRequest
	(*ListNetworkInstanceResponse)(nil),         // 17: api.manage.ListNetworkInstanceResponse
	(*DeleteNetworkInstanceRequest)(nil),        // 18: api.manage.DeleteNetworkInstanceRequest
	(*DeleteNetworkInstanceResponse)(nil),       // 19: api.manage.DeleteNetworkInstanceResponse
	(*GetNetworkInstanceConfigRequest)(nil),     // 20: api.manage.GetNetworkInstanceConfigRequest
	(*GetNetworkInstanceConfigResponse)(nil),    // 21: api.manage.GetNetworkInstanceConfigResponse
	(*ListNetworkInstanceMetaRequest)(nil),      // 22: api.manage.ListNetworkInstanceMetaRequest
	(*ListNetworkInstanceMetaResponse)(nil),     // 23: api.manage.ListNetworkInstanceMetaResponse
	nil,                                         // 24: api.manage.NetworkInstanceRunningInfoMap.MapEntry
	(common.CompressionAlgoPb)(0),               // 25: common.CompressionAlgoPb
	(*common.SecureModeConfig)(nil),             // 26: common.SecureModeConfig
	(*acl.Acl)(nil),                             // 27: acl.Acl
	(*common.Ipv4Inet)(nil),                     // 28: common.Ipv4Inet
	(*peer_rpc.GetIpListResponse)(nil),          // 29: peer_rpc.GetIpListResponse
	(*common.StunInfo)(nil),                     // 30: common.StunInfo
	(*common.Url)(nil),                          // 31: common.Url
	(*api_instance.Route)(nil),                  // 32: api.instance.Route
	(*api_instance.PeerInfo)(nil),               // 33: api.instance.PeerInfo
	(*api_instance.PeerRoutePair)(nil),          // 34: api.instance.PeerRoutePair
	(*peer_rpc.RouteForeignNetworkSummary)(nil), // 35: peer_rpc.RouteForeignNetworkSummary
	(*common.UUID)(nil),                         // 36: common.UUID
}
var file_api_manage_proto_depIdxs = []int32{
	...
	3,  // 1: api.manage.NetworkConfig.port_forwards:type_name -> api.manage.PortForwardConfig
	25, // 2: api.manage.NetworkConfig.data_compress_algo:type_name -> common.CompressionAlgoPb
	26, // 3: api.manage.NetworkConfig.secure_mode:type_name -> common.SecureModeConfig
	27, // 4: api.manage.NetworkConfig.acl:type_name -> acl.Acl
	28, // 5: api.manage.MyNodeInfo.virtual_ipv4:type_name -> common.Ipv4Inet
	29, // 6: api.manage.MyNodeInfo.ips:type_name -> peer_rpc.GetIpListResponse
	30, // 7: api.manage.MyNodeInfo.stun_info:type_name -> common.StunInfo
	31, // 8: api.manage.MyNodeInfo.listeners:type_name -> common.Url
	4,  // 9: api.manage.NetworkInstanceRunningInfo.my_node_info:type_name -> api.manage.MyNodeInfo
	32, // 10: api.manage.NetworkInstanceRunningInfo.routes:type_name -> api.instance.Route
	33, // 11: api.manage.NetworkInstanceRunningInfo.peers:type_name -> api.instance.PeerInfo
	34, // 12: api.manage.NetworkInstanceRunningInfo.peer_route_pairs:type_name -> api.instance.PeerRoutePair
	35, // 13: api.manage.NetworkInstanceRunningInfo.foreign_network_summary:type_name -> peer_rpc.RouteForeignNetworkSummary
	24, // 14: api.manage.NetworkInstanceRunningInfoMap.map:type_name -> api.manage.NetworkInstanceRunningInfoMap.MapEntry
	36, // 15: api.manage.NetworkMeta.inst_id:type_name -> common.UUID
	1,  // 16: api.manage.NetworkMeta.source:type_name -> api.manage.ConfigSource
	2,  // 17: api.manage.ValidateConfigRequest.config:type_name -> api.manage.NetworkConfig
	36, // 18: api.manage.RunNetworkInstanceRequest.inst_id:type_name -> common.UUID
	2,  // 19: api.manage.RunNetworkInstanceRequest.config:type_name -> api.manage.NetworkConfig
	1,  // 20: api.manage.RunNetworkInstanceRequest.source:type_name -> api.manage.ConfigSource
	36, // 21: api.manage.RunNetworkInstanceResponse.inst_id:type_name -> common.UUID
	36, // 22: api.manage.RetainNetworkInstanceRequest.inst_ids:type_name -> common.UUID
	36, // 23: api.manage.RetainNetworkInstanceResponse.remain_inst_ids:type_name -> common.UUID
	36, // 24: api.manage.CollectNetworkInfoRequest.inst_ids:type_name -> common.UUID
	6,  // 25: api.manage.CollectNetworkInfoResponse.info:type_name -> api.manage.NetworkInstanceRunningInfoMap
	36, // 26: api.manage.ListNetworkInstanceResponse.inst_ids:type_name -> common.UUID
	36, // 27: api.manage.DeleteNetworkInstanceRequest.inst_ids:type_name -> common.UUID
	36, // 28: api.manage.DeleteNetworkInstanceResponse.remain_inst_ids:type_name -> common.UUID
	36, // 29: api.manage.GetNetworkInstanceConfigRequest.inst_id:type_name -> common.UUID
	2,  // 30: api.manage.GetNetworkInstanceConfigResponse.config:type_name -> api.manage.NetworkConfig
	1,  // 31: api.manage.GetNetworkInstanceConfigResponse.source:type_name -> api.manage.ConfigSource
	36, // 32: api.manage.ListNetworkInstanceMetaRequest.inst_ids:type_name -> common.UUID
	7,  // 33: api.manage.ListNetworkInstanceMetaResponse.metas:type_name -> api.manage.NetworkMeta
	5,  // 34: api.manage.NetworkInstanceRunningInfoMap.MapEntry.value:type_name -> api.manage.NetworkInstanceRunningInfo
	8,  // 35: api.manage.WebClientService.ValidateConfig:input_type -> api.manage.ValidateConfigRequest
	10, // 36: api.manage.WebClientService.RunNetworkInstance:input_type -> api.manage.RunNetworkInstanceRequest
	12, // 37: api.manage.WebClientService.RetainNetworkInstance:input_type -> api.manage.RetainNetworkInstanceRequest
	14, // 38: api.manage.WebClientService.CollectNetworkInfo:input_type -> api.manage.CollectNetworkInfoRequest
	16, // 39: api.manage.WebClientService.ListNetworkInstance:input_type -> api.manage.ListNetworkInstanceRequest
	18, // 40: api.manage.WebClientService.DeleteNetworkInstance:input_type -> api.manage.DeleteNetworkInstanceRequest
	20, // 41: api.manage.WebClientService.GetNetworkInstanceConfig:input_type -> api.manage.GetNetworkInstanceConfigRequest
	22, // 42: api.manage.WebClientService.ListNetworkInstanceMeta:input_type -> api.manage.ListNetworkInstanceMetaRequest
	9,  // 43: api.manage.WebClientService.ValidateConfig:output_type -> api.manage.ValidateConfigResponse
	11, // 44: api.manage.WebClientService.RunNetworkInstance:output_type -> api.manage.RunNetworkInstanceResponse
	13, // 45: api.manage.WebClientService.RetainNetworkInstance:output_type -> api.manage.RetainNetworkInstanceResponse
	15, // 46: api.manage.WebClientService.CollectNetworkInfo:output_type -> api.manage.CollectNetworkInfoResponse
	17, // 47: api.manage.WebClientService.ListNetworkInstance:output_type -> api.manage.ListNetworkInstanceResponse
	19, // 48: api.manage.WebClientService.DeleteNetworkInstance:output_type -> api.manage.DeleteNetworkInstanceResponse
	21, // 49: api.manage.WebClientService.GetNetworkInstanceConfig:output_type -> api.manage.GetNetworkInstanceConfigResponse
	23, // 50: api.manage.WebClientService.ListNetworkInstanceMeta:output_type -> api.manage.ListNetworkInstanceMetaResponse
...
func file_api_manage_proto_init() {
	...
	file_api_manage_proto_msgTypes[2].OneofWrappers = []any{}
