...
import (
	...
	api_manage "github.com/EasyTier/EasyTier/go/internal/proto/api_manage"
...
type PatchConfigRequest struct {
	...
	Instance      *api_instance.InstanceIdentifier `protobuf:"bytes,2,opt,name=instance,proto3" json:"instance,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PatchConfigRequest) GetInstance() *api_instance.InstanceIdentifier {
	if x != nil {
		return x.Instance
	}
	return nil
...
type GetConfigRequest struct {
	state         protoimpl.MessageState           `protogen:"open.v1"`
	Instance      *api_instance.InstanceIdentifier `protobuf:"bytes,1,opt,name=instance,proto3" json:"instance,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetConfigRequest) GetInstance() *api_instance.InstanceIdentifier {
	if x != nil {
		return x.Instance
	}
	return nil
...
type GetConfigResponse struct {
	state         protoimpl.MessageState    `protogen:"open.v1"`
	Config        *api_manage.NetworkConfig `protobuf:"bytes,1,opt,name=config,proto3" json:"config,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetConfigResponse) GetConfig() *api_manage.NetworkConfig {
	if x != nil {
		return x.Config
	}
	return nil
...
var file_api_config_proto_goTypes = []any{
	...
	(*api_instance.InstanceIdentifier)(nil), // 19: api.instance.InstanceIdentifier
	(*api_manage.NetworkConfig)(nil),        // 20: api.manage.NetworkConfig
}
